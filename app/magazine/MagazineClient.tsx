        ...
        {filtered.map((a) => (
          ...
          >
            <div className="relative h-52 overflow-hidden">
              ...
              <span className="absolute top-3 left-3 text-xs font-semibold px-2 py-0.5 rounded-full" style={{ backgroundColor: "#E8A020", color: "#0F0F1A" }}>
                {a.category}
              </span>
              {a.series && (
                <span className="absolute top-3 right-3 text-xs font-medium px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(232,160,32,0.15)", color: "#E8A020", border: "1px solid rgba(232,160,32,0.35)" }}>
                  Series
                </span>
              )}
            </div>
